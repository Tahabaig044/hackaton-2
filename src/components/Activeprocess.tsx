...
const ActiveProcess = () => {
  return (
    <div className=" mt-[50px] md:mt-[80px] lg:mt-[100px] ">
      ...
      <div className=" top-0 left-0 flex flex-col justify-end items-end text-end w-full py-[20px] md:py-[30px] px-[20px] md:px-[60px] lg:px-[130px] text-white bg-[#0d0d0da1] md:text-sm">
